...
# DDR3 differential system clock on C1/B1
set_property IOSTANDARD LVDS_25 [get_ports SYS_CLK_clk_p]
set_property IOSTANDARD LVDS_25 [get_ports SYS_CLK_clk_n]
set_property PACKAGE_PIN C1 [get_ports SYS_CLK_clk_p]
set_property PACKAGE_PIN B1 [get_ports SYS_CLK_clk_n]
...
set_property PACKAGE_PIN B14 [get_ports aud_pwm]
set_property IOSTANDARD LVCMOS33 [get_ports aud_pwm]

set_property PACKAGE_PIN B13 [get_ports aud_pwm]
set_property IOSTANDARD LVCMOS33 [get_ports aud_pwm]