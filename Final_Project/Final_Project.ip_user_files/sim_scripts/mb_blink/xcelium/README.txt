...
#
# Generated by export_simulation on Thu May 07 12:18:25 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './mb_blink.sh' script.

./mb_blink.sh -reset_run
...
./mb_blink.sh -noclean_files

For more information on the script, please type './mb_blink.sh -help'.
