...
#define HDMI_TEXT_CONTROLLER_REG_OFFSET(RegIndex) ((RegIndex) * 4U)

enum HDMI_TEXT_CONTROLLER_GAME_REGS {
	HDMI_TEXT_CONTROLLER_REG_PLAYER_X = 0,
	HDMI_TEXT_CONTROLLER_REG_PLAYER_Y = 1,
	HDMI_TEXT_CONTROLLER_REG_PLAYER_FIRE = 2,
	HDMI_TEXT_CONTROLLER_REG_SCORE = 3,
	HDMI_TEXT_CONTROLLER_REG_LIVES = 4,
	HDMI_TEXT_CONTROLLER_REG_FRAME_COUNTER = 5,
	HDMI_TEXT_CONTROLLER_REG_DRAW_X = 6,
	HDMI_TEXT_CONTROLLER_REG_DRAW_Y = 7,
	HDMI_TEXT_CONTROLLER_REG_COUNT = 64
};
...
static volatile struct HDMI_TEXT_STRUCT* hdmi_ctrl = (volatile struct HDMI_TEXT_STRUCT*)XPAR_HDMI_TEXT_CONTROLLER_0_AXI_BASEADDR;
