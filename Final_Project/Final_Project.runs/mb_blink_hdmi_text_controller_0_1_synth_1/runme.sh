...
HD_PWD='C:/Users/kakkar3/Desktop/Final_Project/Final_Project.runs/mb_blink_hdmi_text_controller_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_blink_hdmi_text_controller_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_blink_hdmi_text_controller_0_1.tcl
