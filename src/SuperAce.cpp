...
Sprite(id,frameNo,dstRect,point,isVisible,type,currFilm){
    ...
    setBulletAnimationFilm(AnimationFilmHolder::Get()->GetFilm("BULLET_SUPERACE"));
    
    bulletFrame = 2;
    _bulletDstRect.w=bulletAnimationFilm ? bulletAnimationFilm->getFrameBox(bulletFrame).w * Game::getSpriteSize() : 4;
    _bulletDstRect.h=bulletAnimationFilm ? bulletAnimationFilm->getFrameBox(bulletFrame).h * Game::getSpriteSize() : 8;
...
void SuperAce::setBulletFrame(unsigned int _bulletFrame){
    AnimationFilm* animationBulletFilm = AnimationFilmHolder::Get()->GetFilm("BULLET_SUPERACE");
...
void SuperAce::fire(void){
    ...
    AnimationFilm* fireAnimationFilm = AnimationFilmHolder::Get()->GetFilm("BULLET_SUPERACE");
...
Sprite(id,frameNo,dstRect,point,isVisible,type,currFilm){
    ...
    bulletAnimationFilm = AnimationFilmHolder::Get()->GetFilm("BULLET_SUPERACE");
    
    sideFightertBulletDstRect.w=bulletAnimationFilm ? bulletAnimationFilm->getFrameBox(bulletFrame).w * Game::getSpriteSize() /2 : 4;
    sideFightertBulletDstRect.h=bulletAnimationFilm ? bulletAnimationFilm->getFrameBox(bulletFrame).h * Game::getSpriteSize() /2 : 4;
...
void SuperAce::addSideFighters(){
    ...
    AnimationFilm* anim = AnimationFilmHolder::Get()->GetFilm("SIDE_FIGHTER");
    ...
    sideFighter = new SideFighter(this, RIGHT_FIGHTER, sideFighterFrameNo, sideFighterDstRect, getPoint(), getVisibility(), getType(), anim);
    ...
    sideFighter = new SideFighter(this, LEFT_FIGHTER, sideFighterFrameNo, sideFighterDstRect, getPoint(), getVisibility(), getType(), anim);
